				...
				<div className={isAuthenticated ? 'container' : 'contain'}>
					<Routes>
						...
						<Route
							path='/transferMoney'
							element={
								isAuthenticated ? <TransferMoney /> : <Navigate to='/login' />
							}
						/>
						<Route
							path='/payBills'
							element={
								isAuthenticated ? <PayBills /> : <Navigate to='/login' />
							}
						/>
						<Route
							path='/loan'
						...
						<Route
							path='/loan-applied'
							element={
								isAuthenticated ? <LoanApplied /> : <Navigate to='/login' />
							}
						/>
						<Route
						...
						<Route
							path='/card-services'
							element={
								isAuthenticated ? <CreditCard /> : <Navigate to='/login' />
							}
						/>
					</Routes>
				</div>
